export const translations = {
  es: {
    ...
    tooltip_sort_order_asc: "Ordenar: A-Z (Clic para Z-A)",
    tooltip_sort_order_desc: "Ordenar: Z-A (Clic para A-Z)",
    ...
    about_view_release: "Ver página de release",
    ...
    ctx_reset_most_used: "Restablecer más usadas",
    ctx_reset_recents: "Restablecer más recientes",
    ctx_remove_recent: "Quitar de recientes",
    ctx_hide_uptime: "Ocultar tiempo de actividad",
    ctx_hide_launches: "Ocultar lanzamientos",
    ctx_hide_datetime: "Ocultar fecha y hora",
    ctx_configure_footer: "Configuración del pie de página...",
    notif_most_used_reset: "Lista de más usadas restablecida",
    notif_recents_reset: "Historial de más recientes restablecido",
    notif_recent_removed: "Acceso eliminado de recientes",
    ...
    confirm_reset_most_used_title: "¿Restablecer más usadas?",
    confirm_reset_most_used_desc: "¿Estás seguro de que deseas limpiar la lista de aplicaciones más usadas? Se reiniciarán todos los contadores de uso.",
    confirm_reset_recents_title: "¿Restablecer más recientes?",
    confirm_reset_recents_desc: "¿Estás seguro de que deseas limpiar el historial de aplicaciones más recientes?",
    confirm_reset_btn_confirm: "Restablecer",
    ...
    category_created_notif: "Categoría \"{name}\" creada con éxito",
    modal_add_category_title: "Nueva categoría",
    modal_add_category_name_placeholder: "Nombre de la categoría",
    modal_add_category_btn_create: "Crear categoría",
    edit_cat_title: "Editar categoría",
    edit_cat_color: "COLOR",
    ...
    search_action_open_folder: "Abrir carpeta en el Explorador",
    search_action_open_location: "Abrir ubicación de archivo",
    search_action_add_launcher: "Agregar a CyberLauncher",
    cat_all: "Todas",
    ...
    sys_show_footer_uptime: "Mostrar tiempo de actividad en el pie de página",
    sys_show_footer_uptime_desc: "Muestra el tiempo que el sistema lleva encendido en la barra inferior.",
    sys_show_footer_launches: "Mostrar contador de lanzamientos en el pie de página",
    ...
    uwp_terminal_status: "ESCANEANDO SISTEMA...",
    ...
    uwp_log_init: "INICIANDO BÚSQUEDA DE PAQUETES INSTALADOS...",
    uwp_log_connect: "CONSULTANDO CATÁLOGO DE APLICACIONES (shell:AppsFolder)...",
    uwp_log_decrypt: "LEYENDO MANIFIESTOS DE PAQUETES (AppxManifest)...",
    uwp_log_load_aumid: "RESOLVIENDO IDENTIFICADORES DE APLICACIÓN (AUMID)...",
    uwp_log_ntfs: "FILTRANDO COMPONENTES Y SERVICIOS DEL SISTEMA...",
    uwp_log_icons: "EXTRAYENDO ICONOS Y NOMBRES DE APLICACIÓN...",
    uwp_log_hashes: "ORGANIZANDO LISTA DE ACCESOS DIRECTOS...",
    uwp_log_success: "ESCANEO COMPLETADO CORRECTAMENTE.",
    uwp_log_connected_count: "SE ENCONTRARON {count} APLICACIONES DISPONIBLES.",
    uwp_log_import_panel: "LISTA LISTA PARA IMPORTAR EN CYBERLAUNCHER.",
    uwp_log_connected_mock: "MODO DEMOSTRACIÓN: SE CARGARON {count} APLICACIONES.",
    uwp_log_mock_active: "LISTA DE PRUEBA CARGADA.",
    uwp_log_critical_error: "NO SE PUDO OBTENER LA LISTA DE APLICACIONES DE WINDOWS.",
    uwp_log_aborted: "OPERACIÓN CANCELADA.",
    ...
    // Cyber Terminal
    terminal_title: "CYBER TERMINAL",
    terminal_shell_powershell: "PowerShell",
    terminal_shell_cmd: "CMD",
    terminal_status_running: "EJECUTANDO...",
    terminal_status_online: "ONLINE",
    terminal_clear: "Limpiar pantalla",
    terminal_copy_output: "Copiar salida",
    terminal_copied: "¡Copiado!",
    terminal_open_external: "Abrir terminal externa (wt)",
    terminal_kill: "Detener proceso",
    terminal_hint: "Escribe un comando y presiona [Enter]. [↑/↓] historial. [Esc] o [Backspace] para salir.",
    terminal_open_folder: "Abrir carpeta en Explorador",
    terminal_help_builtin: "COMANDOS INTEGRADOS DE CYBER TERMINAL",
    terminal_help_clear: "Limpia los registros de la pantalla",
    terminal_help_cd: "Navega a otra carpeta (ej. cd .., cd C:\\ruta, D:)",
    terminal_help_explorer: "Abre el Explorador de Windows en la carpeta actual",
    terminal_help_wt: "Abre Windows Terminal / PowerShell externo en la ruta activa",
    terminal_help_sys: "Muestra métricas del sistema (CPU, RAM, Uptime)",
    terminal_help_apps: "Muestra el conteo y resumen de accesos configurados",
    terminal_help_help: "Muestra esta ayuda interactiva de comandos",
  },
  en: {
    // Top Bar & General Placeholders
    top_time: "Clock",
    ...
    more_menu_about: "About CyberLauncher...",
    tooltip_minimize: "Minimize to system tray",
    tooltip_uptime: "System uptime",
    tooltip_launches_today: "Launches in the last 24 hours",
    ...
    tooltip_sort_order_asc: "Sort: A-Z (Click for Z-A)",
    tooltip_sort_order_desc: "Sort: Z-A (Click for A-Z)",
    tooltip_close: "Close",
    ...
    about_view_release: "View release page",
    ...
    ctx_reset_most_used: "Reset most used",
    ctx_reset_recents: "Reset most recent",
    ctx_remove_recent: "Remove from recents",
    ctx_hide_uptime: "Hide system uptime",
    ctx_hide_launches: "Hide launch counter",
    ctx_hide_datetime: "Hide date and time",
    ctx_configure_footer: "Footer settings...",
    notif_most_used_reset: "Most used list reset",
    notif_recents_reset: "Most recent history reset",
    notif_recent_removed: "Item removed from recents",
    ...
    confirm_reset_most_used_title: "Reset most used?",
    confirm_reset_most_used_desc: "Are you sure you want to clear the most used apps list? All usage counters will be reset.",
    confirm_reset_recents_title: "Reset most recent?",
    confirm_reset_recents_desc: "Are you sure you want to clear the most recent launch history?",
    confirm_reset_btn_confirm: "Reset",
    ...
    category_created_notif: "Category \"{name}\" created successfully",
    modal_add_category_title: "New Category",
    modal_add_category_name_placeholder: "Category name",
    modal_add_category_btn_create: "Create category",
    ...
    search_action_open_folder: "Open folder in Explorer",
    search_action_open_location: "Open file location",
    search_action_add_launcher: "Add to CyberLauncher",
    cat_all: "All",
    ...
    sys_show_footer_uptime: "Show system uptime in footer",
    sys_show_footer_uptime_desc: "Displays system uptime in the bottom launcher bar.",
    sys_show_footer_launches: "Show launch counter in footer",
    ...
    uwp_terminal_status: "SCANNING SYSTEM...",
    ...
    uwp_log_init: "STARTING SEARCH FOR INSTALLED PACKAGES...",
    uwp_log_connect: "QUERYING APPLICATION CATALOG (shell:AppsFolder)...",
    uwp_log_decrypt: "READING PACKAGE MANIFESTS (AppxManifest)...",
    uwp_log_load_aumid: "RESOLVING APPLICATION USER MODEL IDS (AUMID)...",
    uwp_log_ntfs: "FILTERING SYSTEM COMPONENTS AND BACKGROUND SERVICES...",
    uwp_log_icons: "EXTRACTING ICONS AND APPLICATION NAMES...",
    uwp_log_hashes: "ORGANIZING SHORTCUTS LIST...",
    uwp_log_success: "SCAN COMPLETED SUCCESSFULLY.",
    uwp_log_connected_count: "FOUND {count} AVAILABLE APPLICATIONS.",
    uwp_log_import_panel: "LIST READY FOR IMPORT INTO CYBERLAUNCHER.",
    uwp_log_connected_mock: "DEMO MODE: LOADED {count} APPLICATIONS.",
    uwp_log_mock_active: "TEST LIST LOADED.",
    uwp_log_critical_error: "COULD NOT RETRIEVE WINDOWS APPLICATIONS LIST.",
    uwp_log_aborted: "OPERATION CANCELLED.",
    ...
    terminal_open_external: "Open external terminal (wt)",
    terminal_kill: "Stop process",
    terminal_hint: "Type a command and press [Enter]. [↑/↓] for history. [Esc] or [Backspace] to exit.",
    terminal_open_folder: "Open folder in File Explorer",
    terminal_help_builtin: "CYBER TERMINAL BUILT-IN COMMANDS",
    terminal_help_clear: "Clears terminal logs on screen",
    terminal_help_cd: "Changes working directory (e.g. cd .., cd C:\\path, D:)",
    terminal_help_explorer: "Opens Windows Explorer in current directory",
    terminal_help_wt: "Opens Windows Terminal / external PowerShell in active path",
    terminal_help_sys: "Displays system metrics (CPU, RAM, Uptime)",
    terminal_help_apps: "Displays count and summary of launcher shortcuts",
    terminal_help_help: "Displays this interactive command guide",
  }
};
