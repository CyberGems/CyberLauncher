export const translations = {
  es: {
    ...
    general_monitor_desc: "Monitor donde aparece CyberLauncher. Se recuerda tras reiniciar Windows (por ID y por posición).",
  ...
  en: {
    ...
    general_monitor_desc: "Which monitor CyberLauncher uses. Remembered across Windows restarts (by ID and screen position).",
